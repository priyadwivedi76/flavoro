...
const Navbar = () => {
  return (
    ...
    <div className='flex lg:flex-row md:flex-row flex-col justify-between items-center'>
      ...
      <input type='search' placeholder='Search' className='bg-white h-10 p-5 m-5 border border-gray-300 border-2 rounded-lg w-screen-xl md:w-72 lg:w-112 outline-none'/>
    </div>
